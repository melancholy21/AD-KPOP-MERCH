            ...
            <div className="px-6 md:px-16 lg:px-32 py-14 min-h-screen">
                ...
                <div className="mb-16">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-sm text-gray-500">The duo behind AD KPOP MERCH — built with 💛 for our Technopreneurship subject</p>
                    </div>
                ...
                <div className="text-center py-10 border-t border-gray-100">
                    <div className="inline-flex items-center gap-2 bg-orange-50 border border-orange-100 rounded-full px-6 py-2.5">
                        ...
                        <span className="text-sm font-medium text-orange-600">Built for Technopreneurship</span>
                    </div>
                </div>
