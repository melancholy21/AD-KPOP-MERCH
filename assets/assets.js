...
import lisa_event from "./lisa_event.png";
import enhypen_event from "./enhypen_event.png";
import stayc_event from "./stayc_event.png";
import pre_order_aespa from "./pre_order_aespa.png";
import lesseraphim_pre_order from "./lesseraphim_pre_order.png";
import boynextdoor_pre_order from "./boynextdoor_pre_order.png";
import blackpink_pre_order from "./blackpink_pre_order.png";
import BUBBLE_AESPA_KARINA from "./BUBBLE_AESPA_KARINA.png";
import BUBBLE_AESPA_WINTER from "./BUBBLE_AESPA_WINTER.png";
import BUBBLE_AESPA_NINGNING from "./BUBBLE_AESPA_NINGNING.png";
import BUBBLE_AESPA_GISELLE from "./BUBBLE_AESPA_GISELLE.png";
import BTS_GB_FRONT from "./BTS_GB_FRONT.jpg";
import V_FRIENDS_FRONT from "./V_FRIENDS_FRONT.jpg";
import BROWN_VERSION_BOYNEXTDOOR_CARDS from "./BROWN_VERSION_BOYNEXTDOOR_CARDS.png";
import GREEN_VERSION_AESPA_CARDS from "./GREEN_VERSION_AESPA_CARDS.png";
import PINK_VERSION_LESSERAFIM_CARDS from "./PINK_VERSION_LESSERAFIM_CARDS.png";
...
export const assets = {
  PINK_VERSION_LESSERAFIM_CARDS,
  GREEN_VERSION_AESPA_CARDS,
  BROWN_VERSION_BOYNEXTDOOR_CARDS,
  V_FRIENDS_FRONT,
  BTS_GB_FRONT,
  BUBBLE_AESPA_KARINA,
  BUBBLE_AESPA_WINTER,
  BUBBLE_AESPA_NINGNING,
  BUBBLE_AESPA_GISELLE,
  lesseraphim_pre_order,
  boynextdoor_pre_order,
  blackpink_pre_order,
  pre_order_aespa,
  lisa_event,
  enhypen_event,
